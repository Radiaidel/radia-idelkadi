...
export function ProjectsSection() {
  const projects = [
    {
      title: "Smart IoT Manager",
      description: "A REST API built with Spring Boot to manage IoT devices, measurements, and alerts. The application is secured using JWT, integrates with MongoDB for data persistence, and features containerization with Docker. It includes a CI/CD pipeline using Jenkins and GitHub Actions, detailed API documentation via Swagger, and automated testing with JUnit.",
      tech: ["Spring Boot", "MongoDB", "Docker", "Jenkins", "GitHub Actions", "JWT", "Swagger", "JUnit"],
      img: "https://www.smartcity.co.nz/wp-content/uploads/2021/05/Picture1.jpg",
      github: "https://github.com/Radiaidel/smart-iot-manager",
      external: "#"
    },
